...
const TotalDonationRequests = () => {
    ...
    // const [totalRequests] = useTotalRequests()
    ...
    return (
      ...
      <table className="table">
        ...
        <tbody>
          {/* row 1 */}
          {showAll === false
            ? totalRequests.slice(0, 7).map((req, idx) => (
                <tr key={idx}>
                  <th> {idx + 1} </th>
                  <td>
                    {req.recipientName}
      ...
      <div className=" flex justify-center mt-7  ">
       {
        totalRequests.length > 7 &&  <button className="btn  btn-primary  " onClick={showMore}>
...
export default TotalDonationRequests;